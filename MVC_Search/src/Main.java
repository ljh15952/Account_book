...
public class Main {
	...
	public static void main(String[] args) {
		...
		PersonDetailsAction personDetailsAction = new PersonDetailsAction(searchResultSelectionModel,
...
class PersonDetailsAction extends AbstractAction {
	...
	public PersonDetailsAction(ListSelectionModel personSelectionModel, DefaultListModel personListModel) {
		...
		if (unsupportedSelectionMode) {
			throw new IllegalArgumentException("PersonDetailAction can only handle single list selections. "
	...
	public void actionPerformed(ActionEvent e) {
		...
		PersonElementModel personElementModel = (PersonElementModel) personListModel.get(selectionIndex);
